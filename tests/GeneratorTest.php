...
class GeneratorTest extends TestCase
{
    ...
    public function test_format_sets_the_image_format(): void
    {
    ...
    public function test_an_exception_is_thrown_if_an_unsupported_format_is_used(): void
    {
    ...
    public function test_eye_color_throws_exception_with_number_greater_than_2(): void
    {
        $this->expectException(InvalidArgumentException::class);
        (new Generator)->eyeColor(3, 0, 0, 0, 255, 255, 255);
    }

    public function test_eye_color_throws_exception_with_negative_number(): void
    {
        $this->expectException(InvalidArgumentException::class);
    ...
    public function test_an_exception_is_thrown_for_an_invalid_style(): void
    {
        $this->expectException(InvalidArgumentException::class);
        (new Generator)->style('foo');
    }

    public function test_an_exception_is_thrown_for_a_number_over_1(): void
    {
        $this->expectException(InvalidArgumentException::class);
        (new Generator)->style('round', 1.1);
    }

    public function test_an_exception_is_thrown_for_a_number_under_0(): void
    {
        $this->expectException(InvalidArgumentException::class);
        (new Generator)->style('round', -.1);
    }

    public function test_an_exception_is_thrown_for_1(): void
    {
        $this->expectException(InvalidArgumentException::class);
        (new Generator)->style('round', 1);
    }

    public function test_get_renderer_returns_renderer(): void
    {
        $this->assertInstanceOf(RendererStyle::class, (new Generator)->getRendererStyle());
    }

    public function test_it_calls_a_valid_dynamic_method_and_generates_a_qrcode(): void
    {
    ...
    public function test_it_throws_an_exception_if_datatype_is_not_found(): void
    {
        $this->expectException(BadMethodCallException::class);
        (new Generator)->notReal('fooBar');
    }

    public function test_generator_can_return_illuminate_support_htmlstring(): void
    {
